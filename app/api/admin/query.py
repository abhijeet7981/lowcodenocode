...
create_project = """
insert into projects(project_id,project_name,project_description,project_url,admin_id)
values("{project_id}", "{project_name}","{project_description}","{project_url}","{admin_id}");
"""

create_project_users = """
insert into project_member(project_id,user_id,admin_id)
values("{project_id}", "{user_id}","{admin_id}");
"""

create_project_technology = """
insert into projects_technology (project_id,technology_id,admin_id)
values("{project_id}", "{technology_id}","{admin_id}");
"""
...
projects.created_at ,admin_users.name , admin_users.email 
from projects
...
SELECT projects.project_id , projects.project_name ,projects.project_description , projects.project_url,
projects.created_at ,users.name , users.email 
from projects
...
SELECT projects.project_id , projects.project_name ,projects.project_description , projects.project_url,
projects.created_at ,project_member.user_id, admin_users.name as created_by 
from projects
...
admin_id = '{admin_id}' where project_id = "{project_id}";
"""
...
insertEpic = """
insert into epic (epic_id,project_id,admin_id,epic_subject,epic_description) values 
("{epic_id}","{project_id}","{admin_id}","{epic_subject}","{epic_description}");
"""
...
left join admin_users on epic.admin_id = admin_users.admin_id
where project_id = "{project_id}";
"""

insertStory = """
insert into story (story_id,epic_id,project_id,admin_id,story_subject,story_description) values 
("{story_id}","{epic_id}","{project_id}","{admin_id}","{story_subject}","{story_description}");
"""
...
insertTask = """
insert into tasks (tasks_id,story_id,project_id,admin_id,task_subject,
task_description,priority,status,admin_assigned,estimated_time) 
values 
("{tasks_id}","{story_id}","{project_id}","{admin_id}","{task_subject}",
"{task_description}","{priority}", "{status}", "{admin_assigned}","{estimated_time}");
"""

checkTask = """
select project_id , task_subject , task_description, priority,user_assigned,admin_assigned, status,estimated_time
 from tasks
...
priority = "{priority}", status = "{status}", user_assigned = "{user_assigned}", admin_assigned = Null, 
...
insertCodeData = """
insert into code_generation (code_id,project_id,tasks_id,code_query,code_response,admin_id) values 
("{code_id}", "{project_id}", "{tasks_id}", "{code_query}", "{code_response}","{admin_id}");
"""
...
deleteEpic = """
DELETE from epic WHERE project_id = '{project_id}';
"""

deleteStory = """
DELETE from story WHERE project_id = '{project_id}';
"""
...
DELETE from project_user_roles WHERE project_id = '{project_id}';
"""
...
insertTaskAssignee = """
insert into tasks_assigned (project_id, tasks_id, admin_id)
values
("{project_id}", "{tasks_id}", "{admin_id}");
"""

insertTaskStatusLog = """
insert into tasks_status_log (project_id, tasks_id, admin_id , tasks_status)
values
("{project_id}", "{tasks_id}", "{admin_id}", "{tasks_status}");
"""

insertTaskAssigneeUser = """
...
insertBucket = """
insert into company_storage (company_name, admin_id) values ("{company_name}", "{admin_id}");
"""

insertProjectAttachment = """
insert into project_attachments (company_name, admin_id,project_id,file_name,file_url,stored_file_name)
values ("{company_name}", "{admin_id}", "{project_id}", "{file_name}", "{file_url}", "{stored_file_name}");
"""
...
insert into tasks_attachments ( admin_id, project_id,tasks_id,
file_name,file_url,stored_file_name)
values ("{admin_id}", "{project_id}", "{tasks_id}","{file_name}", "{file_url}", "{stored_file_name}");
"""
...
insert into tasks_comment (admin_id, project_id, tasks_id, manager_comment)
values ("{admin_id}", "{project_id}", "{tasks_id}","{manager_comment}");
"""
